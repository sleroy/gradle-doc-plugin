...
class MarkdownGenerateDocsPDFSpec extends Specification {



	def "Generates PDF Documentation"() {
		...
		Task markdownToHtmlTask = project.tasks.findByName('generateDocsPDF')
